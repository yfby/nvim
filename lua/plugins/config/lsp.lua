-- LSP Configuration
-- Uses mason + mason-lspconfig + nvim-lspconfig
...
local server_settings = {
  ...
  phpactor = {
    settings = {
      phpactor = {
        completion = { enable = true, caseStudy = true },
  ...
  sqls = {
    settings = {
      sqls = { autoSave = true, hover = true, format = true },
    },
  },
}

-- Setup mason-lspconfig with default handler for all servers
-- Each server gets: default_capabilities + its specific overrides from server_settings
mason_lspconfig.setup({
  ...
  handlers = {
    function(server_name)
      local config = vim.deepcopy(server_settings[server_name] or {})
