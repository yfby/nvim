...
function M.open()
  local lines = {
    ...
    "  <leader>J            Toggle split/join (recursive)",
    "",
    "  REPL",
    "  ──────────────────────────────────────────────────────────────────────────",
    "  <leader>rs           Send motion/visual to REPL",
    "  <leader>rf           Send file to REPL",
    "  <leader>rl           Send line to REPL",
    "  <leader>rq           Interrupt REPL",
    "  <leader>rx           Exit REPL",
    "",
    "  NEOTEST",
    "  ──────────────────────────────────────────────────────────────────────────",
    "  :NeotestRun          Run nearest test",
    "  :NeotestSummary      Open test summary",
    "  :NeotestOutput      Show test output",
    "",
    "  TERMINAL",
    "  ──────────────────────────────────────────────────────────────────────────",
    "  Ctrl+\\              Toggle terminal",
    "  <leader>tC           Cycle terminal direction",
    "  <leader>tR           Toggle Python REPL",
    "  <leader>tN           Toggle Node REPL",
    "",
    "  SEARCH & REPLACE",
    "  ──────────────────────────────────────────────────────────────────────────",
    "  :GrugFar             Project-wide search & replace",
    "",
    "  OTHER",
    "  ──────────────────────────────────────────────────────────────────────────",
    "  <leader>up           Lazy",
