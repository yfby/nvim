...
vim.defer_fn(function()
  require("which-key").add({
    ...
    { "<leader>jf",  desc = "Extract field" },
    { "<leader>jn",  desc = "Extract constant" },
    { "<leader>jR",  desc = "Reload project config" },
    { "<leader>jO",  desc = "Open JDT URI" },
    { "<leader>ci",  desc = "Organize imports (CA)" },
    { "<leader>cu",  desc = "Fix all problems" },
